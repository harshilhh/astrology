...
const serviceCategories = [
  {
    category: "Consultation & Prediction", icon: "📞", accent: "#A52020",
    services: [
...
export default function ServicesSection() {
  return (
    <section id="services" style={{ background:"var(--bg-white)", padding:"96px 32px", position:"relative", overflow:"hidden" }}>
      ...
      <div style={{ position:"absolute", top:0, right:0, width:500, height:500, background:"radial-gradient(circle at 80% 10%, rgba(165,32,32,0.04) 0%, transparent 60%)", pointerEvents:"none" }} />
      ...
      <div style={{ maxWidth:1200, margin:"0 auto" }}>
        ...
        <div style={{ textAlign:"center", marginBottom:72 }}>
          ...
          <div style={{ display:"flex", alignItems:"center", justifyContent:"center", gap:16, marginBottom:16 }}>
            <div style={{ height:1, width:60, background:"linear-gradient(90deg, transparent, rgba(165,32,32,0.4))" }} />
            <span style={{ color:"rgba(165,32,32,0.5)", letterSpacing:"0.4em", fontSize:"0.74rem", fontFamily:"var(--font-ui)" }}>✦</span>
            <div style={{ height:1, width:60, background:"linear-gradient(90deg, rgba(165,32,32,0.4), transparent)" }} />
          </div>
        ...
        {serviceCategories.map((cat) => (
          <div key={cat.category} style={{ marginBottom:64 }}>
            {/* Category header */}
            <div style={{ display:"flex", alignItems:"center", gap:16, marginBottom:24, padding:"16px 20px", background:`rgba(${cat.accent === "#A52020" ? "46,158,66" : cat.accent === "#C0392B" ? "192,57,43" : cat.accent === "#6A3FA0" ? "106,63,160" : "26,107,58"},0.05)`, border:`1px solid ${cat.accent}22` }}>
              ...
              {cat.services.map((svc) => (
                <a
                  ...
                  onMouseLeave={e => {
                    ...
                    (e.currentTarget as HTMLElement).style.borderColor="rgba(165,32,32,0.2)";
                  }}
                >
                  {/* Accent dot */}
        ...
        {/* Bottom CTA */}
        <div style={{ textAlign:"center", padding:"52px 32px", background:"var(--bg-cream)", border:"1px solid rgba(165,32,32,0.2)", position:"relative" }}>
          <div style={{ position:"absolute", top:0, left:0, width:32, height:32, borderTop:"1px solid rgba(165,32,32,0.5)", borderLeft:"1px solid rgba(165,32,32,0.5)" }} />
          <div style={{ position:"absolute", top:0, right:0, width:32, height:32, borderTop:"1px solid rgba(165,32,32,0.5)", borderRight:"1px solid rgba(165,32,32,0.5)" }} />
          <div style={{ position:"absolute", bottom:0, left:0, width:32, height:32, borderBottom:"1px solid rgba(165,32,32,0.5)", borderLeft:"1px solid rgba(165,32,32,0.5)" }} />
          <div style={{ position:"absolute", bottom:0, right:0, width:32, height:32, borderBottom:"1px solid rgba(165,32,32,0.5)", borderRight:"1px solid rgba(165,32,32,0.5)" }} />
