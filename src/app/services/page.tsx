...
export const metadata: Metadata = {
  title: "Services | Shri Rajyog Astrologer — Love, Vashikaran & More",
  description: "Explore all astrology services by Shri Rajyog — Love problem solution, Vashikaran, Black magic removal, Marriage issues, Career guidance & more.",
};
    ...
    <>
      ...
      <main style={{ paddingTop: 80 }}>
        ...
        <div style={{ background: "var(--bg-cream)", padding: "60px 24px 48px", textAlign: "center", borderBottom: "3px solid var(--gold-warm)", position: "relative", overflow: "hidden" }}>
          ...
          <span className="section-label" style={{ marginBottom: 16, display: "inline-block" }}>Our Services</span>
          ...
          <p style={{ fontFamily: "var(--font-body)", fontSize: "clamp(0.95rem, 2vw, 1.1rem)", color: "var(--text-secondary)", maxWidth: 540, margin: "16px auto 0", lineHeight: 1.8 }}>
            20+ years of Vedic astrology expertise covering love, marriage, career, spiritual healing and more.
          </p>
        </div>
        <ProblemsSection />
        <ServicesSection />
