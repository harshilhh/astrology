          ...
          <div style={{ maxWidth: 960, margin: "0 auto" }}>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 28, marginBottom: 60 }}>
              {[
                ...
                >
                  <div style={{ width: 72, height: 72, borderRadius: "50%", background: "radial-gradient(circle, rgba(165,32,32,0.15) 0%, rgba(165,32,32,0.05) 100%)", border: "2px solid rgba(165,32,32,0.3)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "2rem", margin: "0 auto 20px" }}>
                    {item.icon}
                  </div>
            ...
            {/* Info box */}
            <div style={{ background: "var(--bg-light-yellow)", border: "1px solid rgba(165,32,32,0.25)", borderRadius: 0, padding: "40px 36px", textAlign: "center" }}>
