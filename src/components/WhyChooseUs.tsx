...
export default function WhyChooseUs() {
  return (
    <section id="about" style={{ background:"var(--bg-light-yellow)", padding:"96px 32px", position:"relative", overflow:"hidden" }}>
      <div style={{ position:"absolute", inset:0, background:"radial-gradient(circle at 90% 10%, rgba(165,32,32,0.05) 0%, transparent 40%), radial-gradient(circle at 10% 90%, rgba(165,32,32,0.03) 0%, transparent 40%)", pointerEvents:"none" }} />
        ...
        <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:48, alignItems:"start" }} className="why-grid">
          ...
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:2 }} className="why-features">
            {features.map((f) => (
              ...
              >
                <div style={{ width:48, height:48, border:"1px solid rgba(165,32,32,0.3)", background:"rgba(165,32,32,0.06)", display:"flex", alignItems:"center", justifyContent:"center", fontSize:"1.5rem", marginBottom:16, position:"relative" }}>
                  {f.icon}
                </div>
                <h4 style={{ fontFamily:"var(--font-display)", fontSize:"1.02rem", fontWeight:700, letterSpacing:"0.08em", textTransform:"uppercase", color:"var(--text-primary)", marginBottom:8 }}>{f.title}</h4>
                <p style={{ fontFamily:"var(--font-body)", fontSize:"1.04rem", color:"var(--text-muted)", lineHeight:1.7 }}>{f.desc}</p>
              </div>
            ))}
          </div>

          {/* Profile card */}
          <div style={{ background:"var(--card-bg)", border:"1px solid rgba(165,32,32,0.25)", padding:"48px 36px", textAlign:"center", position:"relative", boxShadow:"0 20px 60px rgba(0,0,0,0.07), 0 0 40px rgba(165,32,32,0.07)" }}>
            {/* Art Deco corners */}
            <div style={{ position:"absolute", top:0, left:0, width:36, height:36, borderTop:"1px solid rgba(165,32,32,0.6)", borderLeft:"1px solid rgba(165,32,32,0.6)" }} />
            <div style={{ position:"absolute", top:0, right:0, width:36, height:36, borderTop:"1px solid rgba(165,32,32,0.6)", borderRight:"1px solid rgba(165,32,32,0.6)" }} />
            <div style={{ position:"absolute", bottom:0, left:0, width:36, height:36, borderBottom:"1px solid rgba(165,32,32,0.6)", borderLeft:"1px solid rgba(165,32,32,0.6)" }} />
            <div style={{ position:"absolute", bottom:0, right:0, width:36, height:36, borderBottom:"1px solid rgba(165,32,32,0.6)", borderRight:"1px solid rgba(165,32,32,0.6)" }} />
            ...
            <div className="float-anim" style={{ width:100, height:100, margin:"0 auto 24px", position:"relative" }}>
              <div style={{ width:100, height:100, border:"1px solid rgba(165,32,32,0.4)", background:"radial-gradient(circle, rgba(165,32,32,0.12) 0%, rgba(165,32,32,0.04) 100%)", display:"flex", alignItems:"center", justifyContent:"center", fontSize:"2.8rem", boxShadow:"0 0 40px rgba(165,32,32,0.15)" }}>
                🔮
              </div>
              <div style={{ position:"absolute", inset:-8, border:"1px solid rgba(165,32,32,0.15)" }} />
            </div>
            ...
            <p style={{ fontFamily:"var(--font-ui)", fontSize:"0.84rem", fontWeight:700, letterSpacing:"0.35em", textTransform:"uppercase", color:"rgba(165,32,32,0.7)", marginBottom:24 }}>Best Ambaji Upasak Astrologer</p>

            <div style={{ height:1, background:"linear-gradient(90deg, transparent, rgba(165,32,32,0.4), transparent)", marginBottom:24 }} />
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:8, marginBottom:28, textAlign:"left" }}>
              {[
                ...
                <div key={item} style={{ fontFamily:"var(--font-ui)", fontSize:"0.84rem", letterSpacing:"0.04em", color:"var(--text-secondary)", display:"flex", alignItems:"flex-start", gap:10, padding:"8px 12px", background:"rgba(165,32,32,0.04)", border:"1px solid rgba(165,32,32,0.1)" }}>
                  {item}
                </div>
              ))}
            </div>
            ...
            <p style={{ fontFamily:"var(--font-ui)", fontSize:"0.76rem", color:"var(--text-muted)", letterSpacing:"0.18em", textTransform:"uppercase" }}>
