...
const scoreGuide = [
  ...
  { range: "32 – 36", desc: "Superb match — perfect alignment", color: "#8B1A1A" },
];
          ...
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 28, marginBottom: 72 }} className="service-detail-grid">
              {[
                ...
                <div key={m.title} style={{ padding: "36px 32px", background: "var(--bg-light-yellow)", borderRadius: 0, border: "1px solid rgba(165,32,32,0.3)", textAlign: "center" }}>
                ...
                {gunas.map((g) => (
                  <div key={g.name} className="mystical-card" style={{ padding: "24px", borderRadius: 0, background: "var(--card-bg)" }}>
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
                      ...
                      <span style={{ fontFamily: "var(--font-ui)", fontSize: "1rem", fontWeight: 700, color: "var(--gold-deep)", background: "rgba(165,32,32,0.15)", borderRadius: 0, padding: "4px 10px", border: "1px solid rgba(165,32,32,0.3)" }}>{g.points} pts</span>
                    </div>
