...
export default function Footer() {
  ...
  return (
    <footer style={{ background:"var(--bg-light-yellow)", padding:"72px 32px 24px", position:"relative", overflow:"hidden", borderTop:"2px solid rgba(232,86,42,0.2)" }}>
      {/* Green top hairline */}
        ...
        <div style={{ display:"grid", gridTemplateColumns:"2fr 1fr 1fr 1.5fr", gap:48, marginBottom:56 }} className="footer-grid">
          ...
          <div>
            <div style={{ display:"flex", alignItems:"center", gap:12, marginBottom:20 }}>
              {/* Yantra logo */}
              <div style={{ width:44, height:44, border:"1px solid rgba(232,86,42,0.4)", background:"rgba(232,86,42,0.07)", display:"flex", alignItems:"center", justifyContent:"center", flexShrink:0 }}>
                <svg viewBox="0 0 40 40" fill="none" style={{ width:28, height:28 }}>
                  <polygon points="20,4 34,28 6,28" stroke="#E8562A" strokeWidth="1" fill="rgba(232,86,42,0.08)"/>
                  <polygon points="20,36 6,12 34,12" stroke="#F06830" strokeWidth="0.8" fill="rgba(232,86,42,0.05)"/>
                  <circle cx="20" cy="20" r="4" fill="rgba(232,86,42,0.3)" stroke="#E8562A" strokeWidth="0.8"/>
                </svg>
              </div>
              <div>
                ...
                <div style={{ fontFamily:"var(--font-ui)", fontSize:"0.55rem", letterSpacing:"0.3em", textTransform:"uppercase", color:"rgba(232,86,42,0.5)" }}>Best Ambaji Upasak</div>
              </div>
            </div>
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
              {[
                ...
                <a key={item.label} href={item.href} target={item.href.startsWith("http") ? "_blank" : undefined} rel="noopener noreferrer"
                  ...
                  <span style={{ width:36, height:36, border:"1px solid rgba(232,86,42,0.2)", background:"rgba(232,86,42,0.07)", display:"flex", alignItems:"center", justifyContent:"center", fontSize:"1.02rem", flexShrink:0 }}>{item.icon}</span>
                  <div>
                    <div style={{ fontFamily:"var(--font-ui)", fontSize:"0.84rem", letterSpacing:"0.2em", textTransform:"uppercase", color:"rgba(232,86,42,0.5)", marginBottom:2 }}>{item.label}</div>
