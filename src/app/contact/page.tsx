    ...
    <>
      ...
      <main style={{ paddingTop: 80 }}>
        ...
        <div style={{ background: "var(--bg-cream)", padding: "60px 24px 48px", textAlign: "center", borderBottom: "3px solid var(--gold-warm)", position: "relative", overflow: "hidden" }}>
          ...
          <p style={{ fontFamily: "var(--font-ui)", fontSize: "0.85rem", color: "var(--gold-deep)", marginTop: 12, fontWeight: 600 }}>
        ...
        <section style={{ background: "var(--bg-white)", padding: "80px 24px" }}>
          <div style={{ maxWidth: 960, margin: "0 auto" }}>
            ...
            {/* Info box */}
            <div style={{ background: "var(--bg-light-yellow)", border: "1px solid rgba(212,175,55,0.35)", borderRadius: 0, padding: "40px 36px", textAlign: "center" }}>
